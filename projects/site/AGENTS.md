...
- use lowercase for all authored user-facing site copy, including navigation,
...
- keep the landing page restrained: the supplied sky fills the screen, with
  a small bottom footer and a menu that opens on click. avoid large wordmarks
  and decorative black shapes.
- preserve nuxt and the cloudflare worker deployment configuration. do not
